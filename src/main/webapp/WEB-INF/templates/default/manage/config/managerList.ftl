...
<head>
    ...
    <title>管理员 - ${SITE_NAME} - Powered By JEESNS</title>
...
<#include "/manage/common/header.ftl"/>
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <a href="${managePath}/config/managerAdd" target="_jeesnsOpen" title="授权管理员">授权</a>
            </h1>
            <ol class="breadcrumb">
                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <div class="box-tools">
                                <form method="get" action="${managePath}/config/managerList">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="marg-l-5" target="_jeesnsLink"
                                           href="${managePath}/config/managerCancel/${member.id}" confirm="确定要取消管理员吗？">
