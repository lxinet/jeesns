...
<head>
    ...
    <title>会员管理 - ${SITE_NAME} - Powered By JEESNS</title>
                ...
                <div class="col-xs-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            ...
                            <div class="box-tools">
                                <form method="get" action="${managePath}/mem/index">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <#if member.status=-1>
                                        <a class="marg-l-5" target="_jeesnsLink" href="${managePath}/mem/member/isenable/${member.id}" confirm="确定要启用会员吗？">
                                            <span class="label label-danger">禁用</span>
                                        </a>
                                        <#else>
                                        <a class="marg-l-5" target="_jeesnsLink" href="${managePath}/mem/member/isenable/${member.id}" confirm="确定要禁用会员吗？">
