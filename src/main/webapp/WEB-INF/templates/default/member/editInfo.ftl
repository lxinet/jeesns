                            ...
                            <div class="tab-content">
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        <form class="form-horizontal m-t jeesns_form" action="${base}/member/editBaseInfo" method="post">
                                ...
                                <div id="tab-2" class="tab-pane">
                                    <div class="panel-body">
                                        <form class="form-horizontal m-t jeesns_form"
                                            ...
                                            <input name="id" class="form-control" type="hidden" dataType="" value="${loginUser.id}">
                                            <div class="form-group">
                                                <label class="col-sm-2 control-label">生日：</label>
                                                <div class="col-sm-8">
                                                    <input id="birthday" name="birthday" type="text" class="form-control" value="${loginUser.birthday}" onClick="WdatePicker()"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-8 col-sm-offset-2">
                                                    <input type="submit" class="btn btn-primary block full-width m-b jeesns-submit"
                                                           value="修改">
                                                </div>
                                            </div>
                                        </form>
