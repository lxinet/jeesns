...
public class Const {
	...
	public static final String SYSTEM_UPDATE_TIME = "2017-03-14";
	public static final String LAST_SYSTEM_VERSION = "1.0";
	public static final String LAST_SYSTEM_UPDATE_TIME = "2017-03-14";
