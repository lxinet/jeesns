...
<head>
    ...
    <link href="${basePath}/res/plugins/ueditor/themes/default/css/ueditor.min.css" rel="stylesheet">
    ...
    <script type="text/javascript">
        ...
        var uploadServer = "${basePath}/thumbnailUploadImage";
    </script>
        ...
        <div class="row">
            <div class="col-sm-12">
                <ol class="breadcrumb">
                    ...
                    <li><a href="${basePath}/group/detail/${groupTopic.group.id}">${groupTopic.group.name}</a></li>
                    <li><a href="${basePath}/group/topic/${groupTopic.id}">${groupTopic.title}</a></li>
                    <li class="active">编辑</li>
                </ol>
                <div class="ibox">
                    <div class="ibox-content">
                        <form class="form-horizontal jeesns_form" role="form" action="${basePath}/group/topicUpdate"
                              method="post">
