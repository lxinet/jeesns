                ...
                <article class="article article-detail">
                    <header>
                        ...
                        <dl class="dl-inline">
                            ...
                            <dt></dt>
                            <dd class="pull-right">
                                <#--<span class="label label-warning">${groupTopic.articleCate.name}</span>-->
                ...
                <div class="comments panel">
                    ...
                    <header>
                        <div class="reply-form">
                            <form class="form-horizontal jeesns_form" action="${basePath}/group/comment/${groupTopic.id}" method="post">
            ...
            <div class="col-md-4">
                <div class="panel">
                    <div class="panel-body weibo-author">
                        <div class="avatar">
                            <img alt="image" class="img-circle mg-l-30" src="${basePath}${groupTopic.member.avatar}"/>
                        </div>
                        <div class="name">
                        ${groupTopic.member.name}
                        </div>
                        <div class="info">
                            <p>
                                <a href="${basePath}/u/${groupTopic.member.id}/home/follows">${groupTopic.member.follows} 关注</a> /
                                <a href="${basePath}/u/${groupTopic.member.id}/home/fans">${groupTopic.member.fans} 粉丝</a>
                            </p>
                            <p>
