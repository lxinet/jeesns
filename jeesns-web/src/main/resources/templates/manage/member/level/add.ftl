...
<head>
    ...
    <title>添加会员VIP等级 - ${SITE_NAME} - JEESNS后台管理系统 - Powered By JEESNS</title>
...
<div class="wrapper">
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form class="form-horizontal jeesns_form" role="form" action="${managePath}/member/level/save" method="post" callback="parentReload">
