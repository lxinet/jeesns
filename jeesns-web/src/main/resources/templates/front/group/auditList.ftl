                                ...
                                <div class="item-content">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>
                                            ...
                                            <a href="javascript:void(0)" data-href="${groupPath}/audit/${topic.id}" class="btn-link" target="_jeesnsLink" confirm="确定审核通过该帖子吗？" callback="reload">
                                                <span class="label label-badge label-info">审核</span>
                                            </a>
                                            <a href="javascript:void(0)" data-href="${groupPath}/delete/${topic.id}" class="btn-link" target="_jeesnsLink" confirm="确定要删除该帖子吗？" callback="reload">
