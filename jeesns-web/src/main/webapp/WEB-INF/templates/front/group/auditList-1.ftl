            ...
            <div class="col-sm-9">
                ...
                <#list model.data as topic>
                    ...
                    <div class="ibox-content col-sm-12">
                        <div class="col-sm-10">
                            <h3>
                                <a href="${basePath}/group/topic/${topic.id}" class="btn-link" target="_blank">
                                ${topic.title}
                                </a>
                            </h3>
                        ...
                        <div class="col-sm-2">
                            <div class="text-center">
                                <a href="${basePath}/group/audit/${topic.id}" class="btn-link" target="_jeesnsLink">
                                    审核
                                </a>
                ...
                <#if size == 0>
                    ...
                    <div class="box-footer clearfix">
                        <ul class="pagination pagination-sm no-margin pull-right"
                            url="${basePath}/group/auditList/${group.id}"
                    ...
                    <div class="ibox float-e-margins">
                        <div>
                            <div class="ibox-content profile-element">
                                <img alt="image" class="img-circle mg-l-30" src="${basePath}${group.logo}" width="150px"/>
                            </div>
                            <div class="ibox-content profile-content">
                                ...
                                <h4>
                                    ...
                                    <#list managerList as member>
                                        <a href="${basePath}/u/${member.id}" target="_blank">${member.name}</a> ·
                                    </#list>
                                </h4>
                                <#if loginUser?? && loginUser.id == group.creator>
                                    <a class="btn btn-outline btn-primary" href="${basePath}/group/edit/${group.id}">编辑</a>
                                </#if>
                                <#if isfollow == true>
                                    <a class="btn btn-outline btn-primary" title="取消关注"
                                       href="${basePath}/group/nofollow/${group.id}" target="_jeesnsLink">取消关注</a>
                                <#else>
                                    <a class="btn btn-outline btn-primary" title="添加关注"
                                       href="${basePath}/group/follow/${group.id}" target="_jeesnsLink">添加关注</a>
                                </#if>
                                <a class="btn btn-outline btn-info" href="${basePath}/group/post/${group.id}">发帖</a>
                                <p>
                                ${group.introduce!''}
                                </p>
                            </div>
