            ...
            <div class="col-sm-9">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>
                        <a href="${basePath}/u/${weibo.member.id}" target="_blank">${weibo.member.name}</a>
                        ...
                        <div class="ibox-tools">
                            ...
                            <ul class="dropdown-menu dropdown-user">
                                <li><a href="${basePath}/weibo/delete/${weibo.id}" target="_jeesnsLink">删除</a>
                                </li>
                            </ul>
                            </#if>
                        </div>
                ...
                <div class="ibox-content" id="comment">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="form-horizontal m-t jeesns_form" action="${basePath}/weibo/comment/${weibo.id}" method="post">
