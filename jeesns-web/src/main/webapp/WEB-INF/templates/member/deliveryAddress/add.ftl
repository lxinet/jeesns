...
<head>
    ...
    <title>添加收货地址 - ${SITE_NAME} - Powered By JEESNS</title>
            ...
            <div class="col-sm-10 col-xs-12">
                <div class="col-xs-12 white-bg">
                    <div class="list list-condensed ">
                        <header>
                            <h3><i class="icon-list-ul"></i> 添加收货地址</h3>
                        </header>
                        <div class="tab-content m-t-10">
                            <form class="form-horizontal m-t jeesns_form" action="${basePath}/member/deliveryAddress/save" method="post" callback="_success">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label required">收件人姓名：</label>
                                    <div class="col-sm-8">
                                        <input id="name" name="name" class="form-control required" type="text" data-type="require" alt="收件人姓名">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label required">手机号：</label>
                                    <div class="col-sm-8">
                                        <input id="phone" name="phone" class="form-control" type="text" data-type="require" alt="手机号">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label required">所在地区：</label>
                                    <div class="col-sm-2">
                                        <select class="form-control" id="js-province" name="province">
                                        </select>
                                    </div>
                                    <div class="col-sm-2">
                                    ...
                                    <div class="col-sm-2">
                                        <select class="form-control" id="js-area" name="area">
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="address" name="address" class="form-control required" type="text" data-type="require" alt="详细地址">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label required">邮政编码：</label>
                                    <div class="col-sm-8">
                                        <input id="zip" name="zip" class="form-control required" type="text" data-type="require" alt="邮政编码">
                                    </div>
                                </div>
                                <div class="form-group">
