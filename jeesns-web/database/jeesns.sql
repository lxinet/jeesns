...
##数据
INSERT INTO `tbl_config`(`jkey`, `jvalue`, `description`) VALUES
  ('alipay_open', '0', '支付宝支付是否开启，0关闭，1开启'),
  ('cms_post', '0', 'cms会员文章投稿，0关闭，1开启'),
